...
public partial class Controls_ContactForm : System.Web.UI.UserControl
{
  ...
  protected void SendButton_Click(object sender, EventArgs e)
  {
    if (Page.IsValid)
    {
      ...
      myMessage.Subject = "Response from BRENT`S web site";
      myMessage.Body = mailBody;

      myMessage.From = new MailAddress("grant9788@gmail.com", "Sender Name");
      myMessage.To.Add(new MailAddress("grant9788@gmail.com", "Receiver Name"));
